...
function resolveSiteDataByRoute(siteData2, relativePath) {
  ...
  const localeIndex =
    Object.keys(siteData2.locales).find(
      (key) =>
        key !== "root" &&
        !isExternal(key) &&
...
function createRouter(loadPageModule, fallbackComponent) {
  ...
  async function go(href = inBrowser ? location.href : "/") {
    ...
    updateHistory(href);
    await loadPage(href);
    await ((_b = router.onAfterRouteChanged) == null
      ? void 0
      : _b.call(router, href));
  }
  ...
  if (inBrowser) {
    window.addEventListener(
      ...
      (e) => {
        ...
        if (
          ...
          (link2 instanceof SVGElement || !link2.download)
        ) {
          const { target } = link2;
            ...
            if (
              ...
              if (hash) {
                scrollTo(
                  link2,
                  hash,
                  link2.classList.contains("header-anchor"),
                );
              } else {
                updateHistory(href);
                window.scrollTo(0, 0);
    ...
    window.addEventListener("popstate", async (e) => {
      ...
      (_a = router.onAfterRouteChanged) == null
        ? void 0
        : _a.call(router, location.href);
    });
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      if (_ctx.show) {
        _push(
          `<div${ssrRenderAttrs(
            mergeProps({ class: "VPBackdrop" }, _attrs),
          )} data-v-c79a1216></div>`,
        );
      } else {
        _push(`<!---->`);
...
const VPBackdrop = /* @__PURE__ */ _export_sfc(_sfc_main$1c, [
  ["__scopeId", "data-v-c79a1216"],
]);
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      if (localeLinks.value.length) {
        root.value =
          ((_a = localeLinks.value.find(({ link: link2 }) =>
            link2.startsWith(path),
          )) == null
            ? void 0
            : _a.link) || localeLinks.value[0].link;
      }
    });
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d, _e;
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: "NotFound" }, _attrs),
        )} data-v-f87ff6e4><p class="code" data-v-f87ff6e4>${ssrInterpolate(
          ((_a = unref(theme2).notFound) == null ? void 0 : _a.code) ?? "404",
        )}</p><h1 class="title" data-v-f87ff6e4>${ssrInterpolate(
          ((_b = unref(theme2).notFound) == null ? void 0 : _b.title) ??
            "PAGE NOT FOUND",
        )}</h1><div class="divider" data-v-f87ff6e4></div><blockquote class="quote" data-v-f87ff6e4>${ssrInterpolate(
          ((_c = unref(theme2).notFound) == null ? void 0 : _c.quote) ??
            "But if you don't change your direction, and if you keep looking, you may end up where you are heading.",
        )}</blockquote><div class="action" data-v-f87ff6e4><a class="link"${ssrRenderAttr(
          "href",
          unref(withBase)(root.value),
        )}${ssrRenderAttr(
          "aria-label",
          ((_d = unref(theme2).notFound) == null ? void 0 : _d.linkLabel) ??
            "go to home",
        )} data-v-f87ff6e4>${ssrInterpolate(
          ((_e = unref(theme2).notFound) == null ? void 0 : _e.linkText) ??
            "Take me home",
        )}</a></div></div>`,
      );
    };
...
const NotFound = /* @__PURE__ */ _export_sfc(_sfc_main$1b, [
  ["__scopeId", "data-v-f87ff6e4"],
]);
...
function useActiveAnchor(container, marker) {
  ...
  function setActiveLink() {
    ...
    const offsetDocTop = (() => {
      var _a;
      const container2 =
        (_a = document.querySelector("#VPContent .VPDoc")) == null
          ? void 0
          : _a.firstElementChild;
      if (container2) return getAbsoluteTop(container2);
      else return 78;
    })();
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(_ctx.headers, ({ children, link: link2, title }) => {
        _push(
          `<li data-v-b933a997><a class="outline-link"${ssrRenderAttr(
            "href",
            link2,
          )}${ssrRenderAttr("title", title)} data-v-b933a997>${ssrInterpolate(
            title,
          )}</a>`,
        );
...
const VPDocOutlineItem = /* @__PURE__ */ _export_sfc(_sfc_main$1a, [
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        ...
        )} data-v-935f8a84><div class="content" data-v-935f8a84><div class="outline-marker" data-v-935f8a84></div><div class="outline-title" role="heading" aria-level="2" data-v-935f8a84>${ssrInterpolate(
          unref(resolveTitle)(unref(theme2)),
        )}</div><nav aria-labelledby="doc-outline-aria-label" data-v-935f8a84><span class="visually-hidden" id="doc-outline-aria-label" data-v-935f8a84> Table of Contents for current page </span>`,
      );
      _push(
        ssrRenderComponent(
          VPDocOutlineItem,
...
const VPDocAsideOutline = /* @__PURE__ */ _export_sfc(_sfc_main$19, [
  ["__scopeId", "data-v-935f8a84"],
]);
const _sfc_main$18 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: "VPDocAsideCarbonAds" }, _attrs),
        )}>`,
      );
      _push(
        ssrRenderComponent(
...
const _sfc_main$17 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: "VPDocAside" }, _attrs),
        )} data-v-3f215769>`,
      );
...
const VPDocAside = /* @__PURE__ */ _export_sfc(_sfc_main$17, [
...
_sfc_main$16.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    "../node_modules/vitepress/dist/client/theme-default/components/icons/VPIconEdit.vue",
  );
  return _sfc_setup$16 ? _sfc_setup$16(props, ctx) : void 0;
};
const VPIconEdit = /* @__PURE__ */ _export_sfc(_sfc_main$16, [
...
const _sfc_main$14 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(
        `<p${ssrRenderAttrs(
          mergeProps({ class: "VPLastUpdated" }, _attrs),
        )} data-v-7e05ebdb>${ssrInterpolate(
          ((_a = unref(theme2).lastUpdated) == null ? void 0 : _a.text) ||
            unref(theme2).lastUpdatedText ||
            "Last updated",
        )}: <time${ssrRenderAttr(
          "datetime",
          isoDatetime.value,
        )} data-v-7e05ebdb>${ssrInterpolate(datetime.value)}</time></p>`,
      );
    };
  },
});
...
const VPDocFooterLastUpdated = /* @__PURE__ */ _export_sfc(_sfc_main$14, [
  ["__scopeId", "data-v-7e05ebdb"],
]);
      ...
      if (showFooter.value) {
        _push(
          `<footer${ssrRenderAttrs(
            mergeProps({ class: "VPDocFooter" }, _attrs),
          )} data-v-48f9bb55>`,
        );
        ssrRenderSlot(
          _ctx.$slots,
        ...
        if (
          ...
          _push(
            `<nav class="prev-next" data-v-48f9bb55><div class="pager" data-v-48f9bb55>`,
          );
              ...
              ssrRenderComponent(
                ...
                },
                {
                  default: withCtx((_, _push2, _parent2, _scopeId) => {
                    ...
                    if (_push2) {
                      _push2(
                        `<span class="desc" data-v-48f9bb55${_scopeId}>${
                          ((_a2 = unref(theme2).docFooter) == null
                            ? void 0
                            : _a2.prev) || "Previous page"
                        }</span><span class="title" data-v-48f9bb55${_scopeId}>${
                          unref(control).prev.text
                        }</span>`,
                      );
                    } else {
                      return [
...
const VPDocFooter = /* @__PURE__ */ _export_sfc(_sfc_main$13, [
  ["__scopeId", "data-v-48f9bb55"],
]);
...
const VPDoc = /* @__PURE__ */ _export_sfc(_sfc_main$12, [
  ["__scopeId", "data-v-39a288b8"],
]);
...
const VPButton = /* @__PURE__ */ _export_sfc(_sfc_main$11, [
  ["__scopeId", "data-v-c1c5efc1"],
]);
...
const VPImage = /* @__PURE__ */ _export_sfc(_sfc_main$10, [
  ["__scopeId", "data-v-8426fc1a"],
]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        ...
        )} data-v-da5d1713><div class="container" data-v-da5d1713><div class="main" data-v-da5d1713>`,
      );
      ssrRenderSlot(
        _ctx.$slots,
        "home-hero-info",
        ...
        () => {
          if (_ctx.name) {
            _push(
              `<h1 class="name" data-v-da5d1713><span class="clip" data-v-da5d1713>${_ctx.name}</span></h1>`,
            );
          } else {
            _push(`<!---->`);
          }
      ...
      if (_ctx.image || unref(heroImageSlotExists)) {
        _push(
          `<div class="image" data-v-da5d1713><div class="image-container" data-v-da5d1713><div class="image-bg" data-v-da5d1713></div>`,
        );
        ssrRenderSlot(
          _ctx.$slots,
          "home-hero-image",
...
const VPHero = /* @__PURE__ */ _export_sfc(_sfc_main$$, [
  ["__scopeId", "data-v-da5d1713"],
]);
...
function _sfc_ssrRender$b(_ctx, _push, _parent, _attrs) {
  _push(
    ...
    )}><path d="M19.9,12.4c0.1-0.2,0.1-0.5,0-0.8c-0.1-0.1-0.1-0.2-0.2-0.3l-7-7c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4l5.3,5.3H5c-0.6,0-1,0.4-1,1s0.4,1,1,1h11.6l-5.3,5.3c-0.4,0.4-0.4,1,0,1.4c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3l7-7C19.8,12.6,19.9,12.5,19.9,12.4z"></path></svg>`,
  );
}
...
_sfc_main$Z.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    "../node_modules/vitepress/dist/client/theme-default/components/icons/VPIconArrowRight.vue",
  );
  return _sfc_setup$Z ? _sfc_setup$Z(props, ctx) : void 0;
};
const VPIconArrowRight = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                if (typeof _ctx.icon === "object" && _ctx.icon.wrap) {
                  ...
                  _push2(
                    `<div class="icon" data-v-33204567${_scopeId}>${_ctx.icon}</div>`,
                  );
                } else {
                  _push2(`<!---->`);
                }
                _push2(
                  `<h2 class="title" data-v-33204567${_scopeId}>${_ctx.title}</h2>`,
                );
                if (_ctx.details) {
                  _push2(
                    `<p class="details" data-v-33204567${_scopeId}>${_ctx.details}</p>`,
                  );
                } else {
                  _push2(`<!---->`);
                }
                if (_ctx.linkText) {
                  _push2(
                    `<div class="link-text" data-v-33204567${_scopeId}><p class="link-text-value" data-v-33204567${_scopeId}>${ssrInterpolate(
                      _ctx.linkText,
                    )} `,
                  );
                  _push2(
                        ...
                        createBlock(
                          ...
                          [
                            createVNode("p", { class: "link-text-value" }, [
                              createTextVNode(
                                toDisplayString(_ctx.linkText) + " ",
                                1,
                              ),
                              createVNode(VPIconArrowRight, {
                                class: "link-text-icon",
                              }),
                            ]),
                          ],
...
const VPFeature = /* @__PURE__ */ _export_sfc(_sfc_main$Y, [
  ["__scopeId", "data-v-33204567"],
]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (_ctx.features) {
        _push(
          `<div${ssrRenderAttrs(
            mergeProps({ class: "VPFeatures" }, _attrs),
          )} data-v-a6181336><div class="container" data-v-a6181336><div class="items" data-v-a6181336><!--[-->`,
        );
...
const VPFeatures = /* @__PURE__ */ _export_sfc(_sfc_main$X, [
  ["__scopeId", "data-v-a6181336"],
]);
...
const _sfc_main$V = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: "VPHome" }, _attrs),
        )} data-v-d82743a8>`,
      );
...
const VPHome = /* @__PURE__ */ _export_sfc(_sfc_main$V, [
  ["__scopeId", "data-v-d82743a8"],
]);
const _sfc_main$U = {};
...
const VPPage = /* @__PURE__ */ _export_sfc(_sfc_main$U, [
...
const VPContent = /* @__PURE__ */ _export_sfc(_sfc_main$T, [
  ["__scopeId", "data-v-669faec9"],
]);
...
const VPFooter = /* @__PURE__ */ _export_sfc(_sfc_main$S, [
  ["__scopeId", "data-v-e315a0ad"],
]);
...
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs) {
  _push(
    ...
    )}><path d="M9,19c-0.3,0-0.5-0.1-0.7-0.3c-0.4-0.4-0.4-1,0-1.4l5.3-5.3L8.3,6.7c-0.4-0.4-0.4-1,0-1.4s1-0.4,1.4,0l6,6c0.4,0.4,0.4,1,0,1.4l-6,6C9.5,18.9,9.3,19,9,19z"></path></svg>`,
  );
}
...
_sfc_main$R.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    "../node_modules/vitepress/dist/client/theme-default/components/icons/VPIconChevronRight.vue",
  );
  return _sfc_setup$R ? _sfc_setup$R(props, ctx) : void 0;
};
const VPIconChevronRight = /* @__PURE__ */ _export_sfc(_sfc_main$R, [
      ...
      if (_ctx.headers.length > 0) {
        _push(
          `<button class="${ssrRenderClass({
            open: open.value,
          })}" data-v-af18c0d5>${ssrInterpolate(
            unref(resolveTitle)(unref(theme2)),
          )} `,
        );
        _push(
        ...
        _push(
          `<button data-v-af18c0d5>${ssrInterpolate(
            unref(theme2).returnToTopLabel || "Return to top",
          )}</button>`,
        );
      }
      if (open.value) {
        _push(
          `<div class="items" data-v-af18c0d5><div class="header" data-v-af18c0d5><a class="top-link" href="#" data-v-af18c0d5>${ssrInterpolate(
            unref(theme2).returnToTopLabel || "Return to top",
          )}</a></div><div class="outline" data-v-af18c0d5>`,
        );
        _push(
          ssrRenderComponent(
            VPDocOutlineItem,
...
const VPLocalNavOutlineDropdown = /* @__PURE__ */ _export_sfc(_sfc_main$Q, [
  ["__scopeId", "data-v-af18c0d5"],
]);
const _sfc_main$P = {};
...
_sfc_main$P.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    "../node_modules/vitepress/dist/client/theme-default/components/icons/VPIconAlignLeft.vue",
  );
  return _sfc_setup$P ? _sfc_setup$P(props, ctx) : void 0;
};
const VPIconAlignLeft = /* @__PURE__ */ _export_sfc(_sfc_main$P, [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (
        ...
        _push(
          ...
          )} data-v-0282ae07><div class="container" data-v-0282ae07>`,
        );
        if (unref(hasSidebar)) {
          _push(
            `<button class="menu"${ssrRenderAttr(
              "aria-expanded",
              _ctx.open,
            )} aria-controls="VPSidebarNav" data-v-0282ae07>`,
          );
          _push(
            ssrRenderComponent(
              VPIconAlignLeft,
          ...
          _push(
            `<span class="menu-text" data-v-0282ae07>${ssrInterpolate(
              unref(theme2).sidebarMenuLabel || "Menu",
            )}</span></button>`,
          );
        } else {
          _push(`<!---->`);
...
const VPLocalNav = /* @__PURE__ */ _export_sfc(_sfc_main$O, [
  ["__scopeId", "data-v-0282ae07"],
]);
function useNav() {
...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs) {
  _push(
    ...
    )} data-v-b1685198><span class="check" data-v-b1685198>`,
  );
...
const VPSwitch = /* @__PURE__ */ _export_sfc(_sfc_main$N, [
...
_sfc_main$M.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    "../node_modules/vitepress/dist/client/theme-default/components/icons/VPIconMoon.vue",
  );
  return _sfc_setup$M ? _sfc_setup$M(props, ctx) : void 0;
};
const VPIconMoon = /* @__PURE__ */ _export_sfc(_sfc_main$M, [
...
_sfc_main$L.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    "../node_modules/vitepress/dist/client/theme-default/components/icons/VPIconSun.vue",
  );
  return _sfc_setup$L ? _sfc_setup$L(props, ctx) : void 0;
};
const VPIconSun = /* @__PURE__ */ _export_sfc(_sfc_main$L, [
...
const VPSwitchAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$K, [
  ["__scopeId", "data-v-1736f215"],
]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(site).appearance && unref(site).appearance !== "force-dark") {
        _push(
          `<div${ssrRenderAttrs(
            mergeProps({ class: "VPNavBarAppearance" }, _attrs),
          )} data-v-e6aabb21>`,
        );
...
const VPNavBarAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$J, [
  ["__scopeId", "data-v-e6aabb21"],
]);
...
_sfc_main$I.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    "../node_modules/vitepress/dist/client/theme-default/components/icons/VPIconChevronDown.vue",
  );
  return _sfc_setup$I ? _sfc_setup$I(props, ctx) : void 0;
};
const VPIconChevronDown = /* @__PURE__ */ _export_sfc(_sfc_main$I, [
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  _push(
    ...
    )}><circle cx="12" cy="12" r="2"></circle><circle cx="19" cy="12" r="2"></circle><circle cx="5" cy="12" r="2"></circle></svg>`,
  );
}
...
_sfc_main$H.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    "../node_modules/vitepress/dist/client/theme-default/components/icons/VPIconMoreHorizontal.vue",
  );
  return _sfc_setup$H ? _sfc_setup$H(props, ctx) : void 0;
};
const VPIconMoreHorizontal = /* @__PURE__ */ _export_sfc(_sfc_main$H, [
...
const _sfc_main$G = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: "VPMenuLink" }, _attrs),
        )} data-v-43f1e123>`,
      );
      _push(
        ssrRenderComponent(
...
const _sfc_main$F = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: "VPMenuGroup" }, _attrs),
        )} data-v-69e747b5>`,
      );
      if (_ctx.text) {
        _push(
          `<p class="title" data-v-69e747b5>${ssrInterpolate(_ctx.text)}</p>`,
        );
      } else {
        _push(`<!---->`);
      }
...
const _sfc_main$E = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: "VPMenu" }, _attrs),
        )} data-v-e7ea1737>`,
      );
      if (_ctx.items) {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        ...
        )} data-v-9c007e85><button type="button" class="button" aria-haspopup="true"${ssrRenderAttr(
          "aria-expanded",
          open.value,
        )}${ssrRenderAttr("aria-label", _ctx.label)} data-v-9c007e85>`,
      );
...
const _sfc_main$B = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: "VPSocialLinks" }, _attrs),
        )} data-v-7bc22406><!--[-->`,
      );
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  if (unref(localeLinks).length && unref(currentLang).label) {
                    _push2(
                      `<div class="group translations" data-v-d0bd9dde${_scopeId}><p class="trans-title" data-v-d0bd9dde${_scopeId}>${ssrInterpolate(
                        unref(currentLang).label,
                      )}</p><!--[-->`,
                    );
                  ...
                  if (
                    ...
                    _push2(
                      `<div class="group" data-v-d0bd9dde${_scopeId}><div class="item appearance" data-v-d0bd9dde${_scopeId}><p class="label" data-v-d0bd9dde${_scopeId}>${ssrInterpolate(
                        unref(theme2).darkModeSwitchLabel || "Appearance",
                      )}</p><div class="appearance-action" data-v-d0bd9dde${_scopeId}>`,
                    );
                    _push2(
                      ssrRenderComponent(
                        VPSwitchAppearance,
                  ...
                  if (unref(theme2).socialLinks) {
                    _push2(
                      `<div class="group" data-v-d0bd9dde${_scopeId}><div class="item social-links" data-v-d0bd9dde${_scopeId}>`,
                    );
                    _push2(
                      ssrRenderComponent(
                        VPSocialLinks,
        ...
        ssrRenderComponent(
          ...
          ),
          {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(
                  `<span data-v-42ef59de${_scopeId}>${_ctx.item.text}</span>`,
                );
              } else {
                return [
                  createVNode(
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(theme2).nav) {
        _push(
          ...
          )} data-v-7f418b0f><span id="main-nav-aria-label" class="visually-hidden" data-v-7f418b0f>Main Navigation</span><!--[-->`,
        );
...
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: "VPNavBarSearch" }, _attrs),
        )}>`,
      );
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        ...
        )} data-v-8460f0a8><a class="title"${ssrRenderAttr(
          "href",
          link2.value ?? unref(normalizeLink$1)(unref(currentLang).link),
        )}${ssrRenderAttr("rel", rel.value)}${ssrRenderAttr(
          "target",
          target.value,
        )} data-v-8460f0a8>`,
      );
...
_sfc_main$r.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    "../node_modules/vitepress/dist/client/theme-default/components/icons/VPIconLanguages.vue",
  );
  return _sfc_setup$r ? _sfc_setup$r(props, ctx) : void 0;
};
const VPIconLanguages = /* @__PURE__ */ _export_sfc(_sfc_main$r, [
          ...
          ssrRenderComponent(
            ...
            ),
            {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(
                    `<div class="items" data-v-74abcbb9${_scopeId}><p class="title" data-v-74abcbb9${_scopeId}>${ssrInterpolate(
                      unref(currentLang).label,
                    )}</p><!--[-->`,
                  );
                  ssrRenderList(unref(localeLinks), (locale) => {
...
const VPNavBarTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$q, [
  ["__scopeId", "data-v-74abcbb9"],
]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        ...
        )} data-v-19c990f1><div class="wrapper" data-v-19c990f1><div class="container" data-v-19c990f1><div class="title" data-v-19c990f1>`,
      );
      _push(
        ssrRenderComponent(
          VPNavBarTitle,
      ...
      _push(
        `</div><div class="content" data-v-19c990f1><div class="content-body" data-v-19c990f1>`,
      );
      ssrRenderSlot(
        _ctx.$slots,
      ...
      _push(
        `</div></div></div></div><div class="divider" data-v-19c990f1><div class="divider-line" data-v-19c990f1></div></div></div>`,
      );
    };
  },
});
...
const VPNavBar = /* @__PURE__ */ _export_sfc(_sfc_main$p, [
  ["__scopeId", "data-v-19c990f1"],
]);
const _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(site).appearance && unref(site).appearance !== "force-dark") {
        _push(
          `<div${ssrRenderAttrs(
            mergeProps({ class: "VPNavScreenAppearance" }, _attrs),
          )} data-v-2d7af913><p class="text" data-v-2d7af913>${ssrInterpolate(
            unref(theme2).darkModeSwitchLabel || "Appearance",
          )}</p>`,
        );
        _push(ssrRenderComponent(VPSwitchAppearance, null, null, _parent));
...
const VPNavScreenAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$o, [
  ["__scopeId", "data-v-2d7af913"],
]);
...
const VPNavScreenMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$n, [
  ["__scopeId", "data-v-05f27b2a"],
]);
const _sfc_main$m = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(
    ...
    )}><path d="M18.9,10.9h-6v-6c0-0.6-0.4-1-1-1s-1,0.4-1,1v6h-6c-0.6,0-1,0.4-1,1s0.4,1,1,1h6v6c0,0.6,0.4,1,1,1s1-0.4,1-1v-6h6c0.6,0,1-0.4,1-1S19.5,10.9,18.9,10.9z"></path></svg>`,
  );
}
const _sfc_setup$m = _sfc_main$m.setup;
_sfc_main$m.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    "../node_modules/vitepress/dist/client/theme-default/components/icons/VPIconPlus.vue",
  );
  return _sfc_setup$m ? _sfc_setup$m(props, ctx) : void 0;
};
const VPIconPlus = /* @__PURE__ */ _export_sfc(_sfc_main$m, [
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: "VPNavScreenMenuGroupSection" }, _attrs),
        )} data-v-8133b170>`,
      );
      if (_ctx.text) {
        _push(
          `<p class="title" data-v-8133b170>${ssrInterpolate(_ctx.text)}</p>`,
        );
      } else {
        _push(`<!---->`);
      }
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        ...
        )} data-v-65ef89ca><button class="button"${ssrRenderAttr(
          "aria-controls",
          groupId.value,
        )}${ssrRenderAttr(
          "aria-expanded",
          isOpen.value,
        )} data-v-65ef89ca><span class="button-text" data-v-65ef89ca>${
          _ctx.text
        }</span>`,
      );
      _push(
        ssrRenderComponent(VPIconPlus, { class: "button-icon" }, null, _parent),
      );
      _push(
        `</button><div${ssrRenderAttr(
          "id",
          groupId.value,
        )} class="items" data-v-65ef89ca><!--[-->`,
      );
      ssrRenderList(_ctx.items, (item) => {
        _push(`<!--[-->`);
        if ("link" in item) {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(theme2).nav) {
        _push(
          `<nav${ssrRenderAttrs(
            mergeProps({ class: "VPNavScreenMenu" }, _attrs),
          )}><!--[-->`,
        );
        ssrRenderList(unref(theme2).nav, (item) => {
          _push(`<!--[-->`);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(localeLinks).length && unref(currentLang).label) {
        _push(
          ...
          )} data-v-d72aa483><button class="title" data-v-d72aa483>`,
        );
        _push(
          ssrRenderComponent(
            VPIconLanguages,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (_ctx.open) {
        _push(
          ...
          )} data-v-cc5739dd><div class="container" data-v-cc5739dd>`,
        );
        ssrRenderSlot(
          _ctx.$slots,
        ...
        _push(
          ssrRenderComponent(_sfc_main$i, { class: "menu" }, null, _parent),
        );
        _push(
          ssrRenderComponent(
...
const VPNavScreen = /* @__PURE__ */ _export_sfc(_sfc_main$f, [
  ["__scopeId", "data-v-cc5739dd"],
]);
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  __name: "VPNav",
  __ssrInlineRender: true,
...
const VPNav = /* @__PURE__ */ _export_sfc(_sfc_main$e, [
  ["__scopeId", "data-v-ae24b3ad"],
]);
const _sfc_main$d = /* @__PURE__ */ defineComponent({
          ...
          ),
          {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                if (_ctx.item.text) {
                  _push2(
                    `<div class="item"${ssrRenderAttr(
                      "role",
                      itemRole.value,
                    )}${ssrRenderAttr(
                      "tabindex",
                      _ctx.item.items && 0,
                    )} data-v-e31bd47b${_scopeId}><div class="indicator" data-v-e31bd47b${_scopeId}></div>`,
                  );
                  if (_ctx.item.link) {
                    _push2(
                      ssrRenderComponent(
                  ...
                  if (_ctx.item.collapsed != null) {
                    _push2(
                      `<div class="caret" role="button" aria-label="toggle section" tabindex="0" data-v-e31bd47b${_scopeId}>`,
                    );
                    _push2(
                      ssrRenderComponent(
                        VPIconChevronRight,
                          ...
                          _ctx.item.collapsed != null
                            ? (openBlock(),
                              createBlock(
                                ...
                                [
                                  createVNode(VPIconChevronRight, {
                                    class: "caret-icon",
                                  }),
                                ],
                                32,
...
const VPSidebarItem = /* @__PURE__ */ _export_sfc(_sfc_main$d, [
  ["__scopeId", "data-v-e31bd47b"],
]);
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  __name: "VPSidebar",
  __ssrInlineRender: true,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(hasSidebar)) {
        _push(
          ...
          )} data-v-575e6a36><div class="curtain" data-v-575e6a36></div><nav class="nav" id="VPSidebarNav" aria-labelledby="sidebar-aria-label" tabindex="-1" data-v-575e6a36><span class="visually-hidden" id="sidebar-aria-label" data-v-575e6a36> Sidebar Navigation </span>`,
        );
        ssrRenderSlot(
          _ctx.$slots,
          "sidebar-nav-before",
...
const VPSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$c, [
  ["__scopeId", "data-v-575e6a36"],
]);
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  __name: "VPSkipLink",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<!--[--><span tabindex="-1" data-v-0f60ec36></span><a href="#VPContent" class="VPSkipLink visually-hidden" data-v-0f60ec36> Skip to content </a><!--]-->`,
      );
    };
  },
});
...
const VPSkipLink = /* @__PURE__ */ _export_sfc(_sfc_main$b, [
  ["__scopeId", "data-v-0f60ec36"],
]);
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  __name: "Layout",
  __ssrInlineRender: true,
...
const Layout = /* @__PURE__ */ _export_sfc(_sfc_main$a, [
  ["__scopeId", "data-v-5a346dfe"],
]);
const _sfc_main$9 = {};
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    "../node_modules/vitepress/dist/client/theme-default/components/icons/VPIconHeart.vue",
  );
  return _sfc_setup$9 ? _sfc_setup$9(props, ctx) : void 0;
};
const VPIconHeart = /* @__PURE__ */ _export_sfc(_sfc_main$9, [
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(_ctx.data, (sponsor) => {
        _push(
          `<div class="vp-sponsor-grid-item"><a class="vp-sponsor-grid-link"${ssrRenderAttr(
            "href",
            sponsor.url,
          )} target="_blank" rel="sponsored noopener"><article class="vp-sponsor-grid-box"><h4 class="visually-hidden">${ssrInterpolate(
            sponsor.name,
          )}</h4><img class="vp-sponsor-grid-image"${ssrRenderAttr(
            "src",
            sponsor.img,
          )}${ssrRenderAttr("alt", sponsor.name)}></article></a></div>`,
        );
      });
      _push(`<!--]--></div>`);
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<section${ssrRenderAttrs(
          mergeProps({ class: "VPHomeSponsors" }, _attrs),
        )} data-v-96bd69d5><div class="container" data-v-96bd69d5><div class="header" data-v-96bd69d5><div class="love" data-v-96bd69d5>`,
      );
      _push(ssrRenderComponent(VPIconHeart, { class: "icon" }, null, _parent));
      _push(`</div>`);
      if (_ctx.message) {
        _push(
          `<h2 class="message" data-v-96bd69d5>${ssrInterpolate(
            _ctx.message,
          )}</h2>`,
        );
      } else {
      ...
      _push(
        ssrRenderComponent(_sfc_main$7, { data: _ctx.data }, null, _parent),
      );
      _push(`</div>`);
      if (_ctx.actionLink) {
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: "VPDocAsideSponsors" }, _attrs),
        )}>`,
      );
      _push(
        ssrRenderComponent(
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        ...
        )} data-v-0d3d0d4d><div class="profile" data-v-0d3d0d4d><figure class="avatar" data-v-0d3d0d4d><img class="avatar-img"${ssrRenderAttr(
          "src",
          _ctx.member.avatar,
        )}${ssrRenderAttr(
          "alt",
          _ctx.member.name,
        )} data-v-0d3d0d4d></figure><div class="data" data-v-0d3d0d4d><h1 class="name" data-v-0d3d0d4d>${ssrInterpolate(
          _ctx.member.name,
        )}</h1>`,
      );
      if (_ctx.member.title || _ctx.member.org) {
        ...
        if (_ctx.member.title) {
          _push(
            `<span class="title" data-v-0d3d0d4d>${ssrInterpolate(
              _ctx.member.title,
            )}</span>`,
          );
        } else {
            ...
            },
            {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  ...
                  _push2(
                    ` ${ssrInterpolate(_ctx.member.actionText || "Sponsor")}`,
                  );
                } else {
                  return [
                    ...
                    createTextVNode(
                      " " +
                        toDisplayString(_ctx.member.actionText || "Sponsor"),
                      1,
                    ),
                  ];
                }
...
const VPTeamMembersItem = /* @__PURE__ */ _export_sfc(_sfc_main$1, [
  ["__scopeId", "data-v-0d3d0d4d"],
]);
const _sfc_main = /* @__PURE__ */ defineComponent({
